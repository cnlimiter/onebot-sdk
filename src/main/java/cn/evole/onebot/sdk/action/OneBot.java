...
import cn.evole.onebot.sdk.response.contact.*;
...
public interface OneBot {
     ...
     */
    ActionData<MsgId> sendMsg(WholeMessageEvent event, String msg, boolean autoEscape);
     ...
     * @return result {@link ActionData} of {@link MsgId}
     */
    ActionData<MsgId> sendMsg(WholeMessageEvent event, List<ArrayMsg> msg, boolean autoEscape);
